...
COMPRESS      = gzip -9f
DISTNAME      = main1.0.0
DISTDIR = /home/richel/GitHubs/correct_cpp_hello_qt/.tmp/main1.0.0
SUBTARGETS    =  \
		release \
		debug
